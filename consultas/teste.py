...
def estimativa():
    ...
    orders_query = "SELECT id_produto, preco_unitario, quantidade_do_produto_vendida, data_da_compra FROM orders WHERE data_da_compra >= '2023-07-01' AND data_da_compra < '2023-08-01'"
